...
const navigation: INavItem[] = [
    {
        ...
        href: '/bot',
        icon: Bot,
        breadcrumbs: [{ name: 'Agent', href: '/bot', current: true }],
    },
    {
        name: 'Knowledge',
        href: '/knowledge',
        icon: BetweenHorizontalStart,
        breadcrumbs: [{ name: 'Knowledge', href: '/knowledge', current: true }],
    },
    {
        name: 'Model',
        href: '/model',
        icon: Component,
        breadcrumbs: [{ name: 'Model', href: '/model', current: true }],
    },
    {
        name: 'Team Builder',
        href: '/build',
