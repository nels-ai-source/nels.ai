        ...
        <div className=" ">
            ...
            <div className="flex justify-between items-center mb-4">
                ...
                <div className="space-x-2 inline-flex">
                    ...
                    <Tooltip
                        title={
                            isDirty ? 'Save your changes' : 'No unsaved changes'
                        }
                    >
                        <Button
                            type="primary"
            ...
            <div className="space-y-0 rounded border border-secondary">
                <div className="flex justify-between items-start p-4 hover:bg-secondary/5 rounded transition-colors">
                    ...
                    <select
                        value={localUISettings.language}
                        onChange={(e) =>
                ...
                <SettingToggle
                    checked={
                        localUISettings.expanded_messages_by_default ?? false
                    }
                    onChange={(checked) =>
                        handleSettingChange(
                ...
                <SettingToggle
                    checked={
                        localUISettings.show_agent_flow_by_default ?? false
                    }
                    onChange={(checked) =>
                        handleSettingChange(
