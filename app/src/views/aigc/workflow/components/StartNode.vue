...
function logToObject(event) {
    console.log(event);
}
</script>

<template class="node-default">
    <el-text>
        <div class="
      ...
      undefined
      shrink-0 mr-2
    "><svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-3.5 h-3.5" data-icon="Home" aria-hidden="true">
                <g id="icons/home">
    ...
    <Handle type="source" :position="sourcePosition">
        <div class="
                ...
                " data-state="closed"><svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-2.5 h-2.5 text-white" data-icon="Plus02" aria-hidden="true">
                <g id="plus" @click="logToObject">
                    <path id="Icon" d="M5.00004 2.08325V7.91659M2.08337 4.99992H7.91671" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                </g>
            </svg></div>
    </Handle>
</template>
...
.vue-flow__node.selected .flow__handle{
    pointer-events: none;
