<template>
    <div class="max-w-[520px] rounded-sm border border-gray-200 bg-white p-3 shadow-md">
        <div class="flex flex-col gap-y-4">
            ...
            <span class="text-sm text-gray-500">The starting node of the workflow, used to set the information needed to initiate the workflow.</span>
            ...
            <div class="grid gap-y-3">
                <start-input-module v-for="(item, index) in data" :key="index" :data="item" @click-delete="handleClickDeleteBtn(index)" />
            </div>
        </div>
