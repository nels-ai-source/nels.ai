            ...
            <el-container>
                <el-main>
                    <div class="page-content" style=" padding: 10px">
                        <div class="ant-bubble css-var-r4c ant-bubble-start">
                            <div class="ant-bubble-avatar">
                                <el-avatar :size="32" icon="el-icon-user"></el-avatar>
                            </div>
                            <div class="ant-bubble-content-wrapper">
                                <div class="ant-bubble-header">Ant Design X</div>
                                <div class="ant-bubble-content ant-bubble-content-filled">Hello, welcome to use Ant Design X! Just ask if you have any questions.</div>
                                <div class="ant-bubble-footer">
                                    <div class="ant-space ant-space-horizontal ant-space-align-center css-var-r4c" style="gap: 4px;">
                                        <div class="ant-space-item">
                                            <el-button text size="small" icon="el-icon-refresh" class="ant-btn css-var-r4c ant-btn-default ant-btn-color-default ant-btn-variant-text ant-btn-sm ant-btn-icon-only" />
                                        </div>
                                        <div class="ant-space-item">
                                            <el-button text size="small" icon="el-icon-document-copy" class="ant-btn css-var-r4c ant-btn-default ant-btn-color-default ant-btn-variant-text ant-btn-sm ant-btn-icon-only" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="ant-bubble css-var-r4c ant-bubble-end">
                            <div class="ant-bubble-avatar">
                                <el-avatar :size="32" icon="el-icon-user"></el-avatar>
                            </div>
                            <div class="ant-bubble-content ant-bubble-content-filled">Hi, good morning, I'm fine!</div>
                        </div>
                    </div>
                </el-main>
                <el-footer style="height: auto; border-top: none;">
                    <div class="ant-sender css-var-rcd">
                        <div class="ant-sender-content">
                            <div class="ant-sender-prefix">
                                <span class="ant-badge css-var-rcd">
                                    <el-button type="button" icon="el-icon-refresh" class="ant-btn css-var-r4c ant-btn-default ant-btn-color-default ant-btn-variant-text ant-btn-sm ant-btn-icon-only" />
                                    <el-button type="button" icon="el-icon-refresh" class="ant-btn css-var-r4c ant-btn-default ant-btn-color-default ant-btn-variant-text ant-btn-sm ant-btn-icon-only" />
                                </span>
                            </div>
                            <textarea class="ant-input ant-input-borderless css-var-rcd ant-input-css-var ant-sender-input" style="resize: none;"></textarea>
                            <div class="ant-sender-actions-list">
                                <div class="ant-sender-actions-list-presets ant-flex css-var-rcd">
                                    <el-button type="button" icon="el-icon-refresh" class="ant-btn css-var-r4c ant-btn-default ant-btn-color-default ant-btn-variant-text ant-btn-sm ant-btn-icon-only" />
                                </div>
                            </div>
                        </div>
...
.ant-bubble .ant-bubble-content-shadow {
...
textarea.ant-input {
    ...
    transition: all var(--ant-motion-duration-slow), height 0s;
    resize: vertical;
}
</style>
