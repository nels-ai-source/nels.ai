...
public sealed class BaiduPromptExecutionSettings : PromptExecutionSettings
{
    /// <summary>
    ...
    public static BaiduPromptExecutionSettings FromExecutionSettings(PromptExecutionSettings executionSettings)
    {
        switch (executionSettings)
        {
            case null:
                return new BaiduPromptExecutionSettings();
            case BaiduPromptExecutionSettings settings:
                return settings;
        }

        var json = JsonSerializer.Serialize(executionSettings);
        var huggingFacePromptExecutionSettings = JsonSerializer.Deserialize<BaiduPromptExecutionSettings>(json, JsonOptionsCache.ReadPermissive);
