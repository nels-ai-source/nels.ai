...
using Nels.SemanticKernel.DashScope.Services;
...
public static class DashScopeKernelBuilderExtensions
{
        ...
        HttpClient httpClient = null)
    {
        ...
        builder.Services.AddKeyedSingleton<IChatCompletionService>(serviceId, (serviceProvider, _) =>
            new DashScopeChatCompletionService(
                modelId,
                endpoint,
                apiKey,
       ...
       HttpClient httpClient = null)
    {
        ...
        builder.Services.AddKeyedSingleton<ITextEmbeddingGenerationService>(serviceId, (serviceProvider, _) =>
            new DashScopeTextEmbeddingGenerationService(modelId, endpoint, apiKey, HttpClientProvider.GetHttpClient(httpClient, serviceProvider), serviceProvider.GetService<ILoggerFactory>()
            ));
