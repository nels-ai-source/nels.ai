...
using Nels.SemanticKernel.InternalUtilities.System;
...
public abstract class DashScopeToolCallBehavior
{
    ...
    internal abstract void ConfigureDashScopeRequest(Kernel? kernel, DashScopeChatCompletionRequest request);
    ...
    internal sealed class KernelFunctions : DashScopeToolCallBehavior
    {
        ...
        internal override void ConfigureDashScopeRequest(Kernel? kernel, DashScopeChatCompletionRequest request)
        {
