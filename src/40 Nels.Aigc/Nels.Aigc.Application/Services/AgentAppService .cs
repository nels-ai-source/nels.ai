...
public class AgentAppService : RouteCrudGetAllAppService<Agent, AgentDto, Guid, AgentGetListInputDto, AgentUpsertDto, AgentUpsertDto>, IAgentService
{
    ...
    [HttpPost]
    [Route("[action]")]
    public virtual async Task<AgentDto> DetailSaveAsync(Guid id, AgentDto input)
    {
    ...
    private async Task UpdateInputMapToEntityAsync(AgentDto updateInput, Agent entity)
    {
